;; doom-gruvbox-cust-theme.el --- inspired by morhetz Gruvbox -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(def-doom-theme doom-gruvbox-cust
  ...
  ((bg
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ...
          (t                                        '("#080808" "#080808" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-gruvbox-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-gruvbox-dark-variant "soft") '("#080808" "#080808" nil))   ; bg0
          (t                                        '("#080808" "#1e1e1e" nil)))) ; bg_h
   (bg-alt2    '("#151515" "#181818" "black"      )) ; bg2 (for region, selection etc.)

   (base0      '("#0d0d0d" "black"   "black"      )) ; (self-defined)
   (base1      '("#1d1d1d" "#1e1e1e" "brightblack")) ; bg0_h
   ...
   (fg         '("#efefef" "#ffffff" "brightwhite")) ; fg/fg1
   (fg-alt     '("#bbbbbb" "#cccccc" "brightwhite")) ; fg2
   ...
   ;; face categories
   (highlight      yellow)
   (vertical-bar   base0) ; this is'nt just vertical bar, was originally "grey"
   (selection      bg)
   (builtin        orange)
  ...
  (
   ...
   ((line-number-current-line &override) :background base0 :foreground base5)
...
;;; doom-gruvbox-cust-theme.el ends here
